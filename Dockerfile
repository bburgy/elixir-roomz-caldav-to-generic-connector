...
#   - Ex: docker.io/hexpm/elixir:1.18.4-erlang-27.2.4-debian-bookworm-20250811-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/roomz_caldav_to_generic_connector ./
