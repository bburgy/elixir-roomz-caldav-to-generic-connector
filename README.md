...
services:
  app:
    image: ghcr.io/bburgy/elixir-roomz-caldav-to-generic-connector:0.2.1
    ports:
      - 80:4000/tcp
    build:
      context: .
...
| `SECRET_KEY_BASE`       | Secret key generated by phoenix: `https://hexdocs.pm/phoenix/deployment.html` |                                               |
